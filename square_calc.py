...
while True: # Run forever until stopped
    ...
    if ((l != 0 and l != l_solved) or (p != 0 and p != p_solved) or (a != 0 and a != a_solved)):
        ...
        input("\nPress enter to continue") # Wait for the user to press enter before continuing. This prevents the loop from restarting and clearing the screen immediately after displaying the results of the calculations.
